...
export async function handleGetAssessment(assessmentId: string, env: RiskEnv): Promise<Response> {
...
export async function handleGetHistory(agentId: string, env: RiskEnv, url: URL): Promise<Response> {
...
export async function handleGetProof(proofId: string, env: RiskEnv): Promise<Response> {
