...
**[Agent Alignment Protocol (AAP)](https://github.com/mnemom/aap)** — The missing trust layer for the agent stack. An open protocol that gives every AI agent a verifiable record of its decisions, values, and reasoning. Integrates with A2A and MCP.
